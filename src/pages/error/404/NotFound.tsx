...
<div className={styles.container}>
	<div className={styles.left_section}>
		<div className={styles.inner_content}>
			...
			<p className={styles.subheading}>Мы не можем найти, что вам необходимо</p>
		</div>
	</div>
        ...
        <g id="lamp">
          ...
          <radialGradient id="SVGID_1_" cx="119.676" cy="44.22" r="65" gradientUnits="userSpaceOnUse">
            ...
            <stop  offset="50%" style={{stopColor: "#EDEDED", stopOpacity: 0.5}}>
              <animate attributeName="stopOpacity" values="0.0; 0.5; 0.0" dur="5000ms" repeatCount="indefinite"></animate>
            </stop>
